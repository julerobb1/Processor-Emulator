...
namespace ProcessorEmulator.Core
{
    ...
    public static class HostHardDisk
    {
        ...
        public static bool TryStep(uint[] registers, MipsBus bus, ref uint programCounter)
        {
            ...
            CeRomTocFiles.TryNoteTv2ImplicitContinue(bus, pc, registers);
            CeRomTocFiles.TryNoteTv2ImplicitPast(bus, pc, registers);
            CeRomTocFiles.TryNoteTv2StoreContinue(bus, pc, registers);
            ...
            CeRomTocFiles.TryKeepTv2LeftoverS6(bus, registers, programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastAfterCaf0(bus, programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb0c(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb10(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb14(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb14(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb34(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb34(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb38(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb38(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb3c(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb3c(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb40(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb40(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb44(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb44(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb48(bus, registers, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb48(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastCb4c(bus, registers, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterCb4c(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastJrRa(bus, registers, programCounter);
            ...
            CeRomTocFiles.TryResumeTv2LeftoverAfterBPlus2Taken(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastBPlus2Next(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterFp(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastFpNext(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterS7(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastS7Next(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterS6(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastS6Next(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterS5(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastS5Next(bus, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverAfterS4(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastS4Next(bus, programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverDrop(bus, registers, programCounter);
            CeRomTocFiles.TryResumeTv2LeftoverDestLiveContinue(bus, registers, ref programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastEpilogue(bus, registers, programCounter);
            CeRomTocFiles.TryNoteTv2LeftoverPastEpilogueDelay(bus, registers, programCounter);
            ...
            CeRomTocFiles.TryNoteTv2AfterExnContinue(bus, pc);
        ...
        private static void ObserveGwesPath(uint pc, uint[] registers, MipsBus bus)
        {
                ...
                && registers != null && registers.Length > 4)
            {
                ...
                if (CeRomTocFiles.IsMscoreeTocObject(bus, registers[4])
                    && _logged.Add("hive:ldde32:mscoree"))
                {
                    ...
                    System.Console.WriteLine("[Hive] 0x800196E4 ExtraROM mscoree.dll obj=0x" +
                        ...
                        " e32=0x" + CeRomTocFiles.MscoreeE32.ToString("X8") +
            ...
            uint[] registers, MipsBus bus)
        {
            ...
            CeRomTocFiles.TryNoteLeftoverWait99O32NkCoredllExn(code, epc, vaddr,
                vector, registers, bus);
