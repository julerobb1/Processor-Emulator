...
Write-Host "🏗️ Architecture: ARM (Cortex-A15)" -ForegroundColor Green
...
Write-Host "🖥️ QEMU will open a separate window with the live boot process" -ForegroundColor Red
